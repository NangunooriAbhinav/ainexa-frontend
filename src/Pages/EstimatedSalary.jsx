...
useEffect(() => {
  ...
  return (
    <div className='maxw-screen-2xl container mx-auto xl:px-24 px-4'>
...
//   useEffect(() => {
//     // Fetch data from salary.json and store in both salary and originalSalary states
//     fetch('salary.json')
//       .then((res) => res.json())
//       .then((data) => {
//         setSalary(data);
...
//   // Handle search based on searchText
//   useEffect(() => {
//     if (searchText.trim() === '') {
//       setSalary(originalSalary); // If search text is empty, display all original salary items
//     } else {
//       const filtered = originalSalary.filter((job) =>
//         job.title.toLowerCase().includes(searchText.toLowerCase())
//       );
//       setSalary(filtered); // Filter salary items based on job title
//     }
//   }, [searchText, originalSalary]);
