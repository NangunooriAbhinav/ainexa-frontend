  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
      ...
      <p className="text-lg text-black/70 mb-8">
        Thousands of jobs in the computer, engineering, and technology sector
        are waiting for you.
      </p>
      <form>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        ...
        <div className="bg-white rounded-md shadow-md p-6">
          ...
          <p className="text-gray-700">
            Apply to inumerous job openings with just few clicks and some
            personal details.
          </p>
        ...
        <div className="bg-white rounded-md shadow-md p-6">
          <h2 className="text-xl font-semibold mb-2">
            MCQ practice and reviews here
          </h2>
          <p className="text-gray-700">
            Get all resources for skill prep and upgrade your concept here .
          </p>
          <div className="flex mt-4">
            <button className="bg-blue text-white px-4 py-2 rounded-md">
              <a
                href="http://127.0.0.1:5500/quizmain/index.html"
                target="_blank"
              >
                MCQ Test
              </a>
        ...
        <div className="bg-white rounded-md shadow-md p-6">
          ...
          <p className="text-gray-700">
            Practice Various coding problems and improve skills.
          </p>
          <div className="flex mt-4">
            <button className="bg-blue text-white px-4 py-2 rounded-md">
              <a
                href="https://git.coffeecodes.in/-/ide/project/root/bits-goa-hackathon/edit/main/-/"
                target="_blank"
              >
                Code now
              </a>
